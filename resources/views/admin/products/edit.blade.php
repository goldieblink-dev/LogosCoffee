        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div class="space-y-6">
                ...
                <div class="flex items-center gap-3">
                    <input type="checkbox" name="is_available" id="is_available" value="1" {{ $product->is_available ?
                    'checked' : '' }}
            ...
            <div class="space-y-6">
                <div>
                    ...
                    <textarea name="description" id="description" rows="5"
                        class="w-full px-4 py-2 bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:border-black transition-colors">{{ old('description', $product->description) }}</textarea>
                ...
                <div>
                    <label for="image" class="block text-xs font-bold uppercase tracking-wider text-gray-700 mb-2">Foto
                        Produk</label>
                    @if($product->image)
                    <div class="mb-4 w-32 h-32 border border-gray-200 rounded-lg overflow-hidden">
