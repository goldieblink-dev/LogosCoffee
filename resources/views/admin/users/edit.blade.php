...
<div class="max-w-2xl bg-white border border-gray-200 rounded-2xl shadow-sm p-8">
    <form action="{{ route('users.update', $user) }}" method="POST">
        ...
        <div class="space-y-6">
            ...
            <div>
                <label for="role" class="block text-xs font-bold uppercase tracking-wider text-gray-700 mb-2">Peran
                    (Role)</label>
            ...
            <div class="p-4 bg-gray-50 rounded-lg border border-gray-200">
                <p class="text-xs text-gray-500 mb-4 font-bold uppercase tracking-tighter italic">Kosongkan jika tidak
                    ingin mengubah password</p>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        <label for="password"
                            class="block text-xs font-bold uppercase tracking-wider text-gray-700 mb-2">Password
                            Baru</label>
                        <input type="password" name="password" id="password"
                            class="w-full px-4 py-2 bg-white border border-gray-200 rounded-lg focus:outline-none focus:border-black transition-colors">
